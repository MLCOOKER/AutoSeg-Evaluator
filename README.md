...
`tests/vendor/`, `tests/test_staple_equivalence.py`, and
...
[dcmrtstruct2nii](https://github.com/Sikerdebaard/dcmrtstruct2nii),
and [dicompyler-core](https://github.com/dicompyler/dicompyler-core). The 2D
